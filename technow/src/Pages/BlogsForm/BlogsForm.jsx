...
const [failure , setFailure ] = useState(false)
  ...
  const addBlog=(e)=>{
    ...
    const formData= new FormData(e.target);
      ...
      axios.post("http://localhost:5000/add/blogs", formData)
      .then((response)=>{
      ...
      <div className={styles.Top}>
        <div className={styles.Left}>
          <form className={styles.form} action="" onSubmit={addBlog}>
              ...
              <input className={styles.input}  type="text" id="fullname" name="author" />
        ...
        <Link to='/blog'><Button color={"green"} text={"Go back to Blogs"} size={"big"}/></Link>
        </div>
